...
def create_sequences(features, target,index, sequence_length):
    ...
    for i in range(len(features) - sequence_length):
        ...
        idx.append(index[i + sequence_length])
